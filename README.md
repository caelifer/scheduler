...
`scheduler` is a simple load-balancer across n-workers. It maintains a buffered channel of work-uinits represented via [jobs.Interface](github.com/caelifer/scheduler/jobs.Interface)
